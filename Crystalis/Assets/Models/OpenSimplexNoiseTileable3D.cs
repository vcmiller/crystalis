...
public class OpenSimplexNoiseTileable3D {
    ...
    public OpenSimplexNoiseTileable3D(int w6, int h6, int d6) : this(DEFAULT_SEED, w6, h6, d6) {
    }
    ...
    public OpenSimplexNoiseTileable3D(short[] perm, int w6, int h6, int d6) {
        ...
        this.h6 = h6;
        this.d6 = d6;
        sOffset = Mathf.Max(w6, Mathf.Max(h6, d6)) * 6;
    ...
    private static float[] gradients3D = new float[] {
